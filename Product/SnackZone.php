...
// Fetch Snacks products from the database
$products = [];
$sql = "SELECT id, name, price, image, sub_category, unit FROM products WHERE category = 'Snacks' ORDER BY name ASC";
...
<head>
  <meta charset="UTF-8">
  <title>Dunzo Snacks | Tasty Treats at Your Doorstep</title>
...
<body>
 ...
 <a href="/DunzoQuick/index.php" class="back-btn"><i class="fas fa-arrow-left"></i> Back to Home</a>
  ...
  <ul class="grocery-categories">
    ...
    <li onclick="filterCategory('chips', this)">🥔 Chips</li>
    <li onclick="filterCategory('chocolates', this)">🍫 Chocolates</li>
    <li onclick="filterCategory('biscuits', this)">🍪 Biscuits</li>
    <li onclick="filterCategory('drinks', this)">🥤 Drinks</li>
  </ul>
  ...
  <section class="product-grid" id="productGrid">
      <?php if (!empty($products)): ?>
        ...
        <?php endforeach; ?>
      <?php else: ?>
        <p>No snack products found. Please check back later!</p>
      <?php endif; ?>
  </section>
