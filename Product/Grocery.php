...
<head>
  <meta charset="UTF-8">
  <title>Grocery Store | Full Category Listing</title>
...
<body>
 ...
 <a href="/DUNZO/index.php" class="back-btn"><i class="fas fa-arrow-left"></i> Back to Home</a>
  ...
  <ul class="grocery-categories">
    ...
    <li data-filter="fruits" onclick="filterCategory('fruits', this)">🍎 Fruits</li>
    <li data-filter="vegetables" onclick="filterCategory('vegetables', this)">🥬 Vegetables</li>
    <li data-filter="dairy" onclick="filterCategory('dairy', this)">🥛 Dairy</li>
    <li data-filter="bakery" onclick="filterCategory('bakery', this)">🍞 Bakery</li>
    <li data-filter="grains" onclick="filterCategory('grains', this)">🍚 Grains</li>
    <li data-filter="household" onclick="filterCategory('household', this)">🧴 Household</li>
    <li data-filter="snacks" onclick="filterCategory('snacks', this)">🍪 Snacks</li>
    <li data-filter="beverages" onclick="filterCategory('beverages', this)">🥤 Beverages</li>
    <li data-filter="frozen" onclick="filterCategory('frozen', this)">🧊 Frozen Foods</li>
  </ul>
  ...
  <section class="product-grid" id="productGrid">
      <?php if (!empty($products)): ?>
        ...
        <?php endforeach; ?>
      <?php else: ?>
        <p>No grocery products found. Please check back later!</p>
      <?php endif; ?>
  </section>
    ...
    <script>
      ...
      function filterCategory(category, element) {
        ...
        products.forEach(product => {
          ...
          // Use an if/else for clarity and to revert to the default display style
          if (category === "all" || productCat === category) {
            product.style.display = ""; // Reverts to the display property from the stylesheet (e.g., grid item)
          } else {
        ...
        const filterButtons = document.querySelectorAll('.grocery-categories li');
