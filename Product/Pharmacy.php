...
$products = [];
$sql = "SELECT id, name, price, image, sub_category, unit 
        FROM products 
...
<head>
  <meta charset="UTF-8">
  <title>Dunzo Pharmacy | Health Essentials Online</title>
...
<body>
 ...
 <a href="/DUNZO/index.php" class="back-btn"><i class="fas fa-arrow-left"></i> Back to Home</a>
  ...
  <ul class="grocery-categories">
    ...
    <li onclick="filterCategory('medicines', this)">💉 Medicines</li>
    <li onclick="filterCategory('wellness', this)">🌿 Wellness</li>
    <li onclick="filterCategory('babycare', this)">👶 Baby Care</li>
    <li onclick="filterCategory('equipment', this)">🩺 Equipment</li>
  </ul>
  ...
  <section class="product-grid" id="productGrid">
      <?php if (!empty($products)): ?>
        ...
        <?php endforeach; ?>
      <?php else: ?>
        <p>No pharmacy products found. Please check back later!</p>
      <?php endif; ?>
  </section>
